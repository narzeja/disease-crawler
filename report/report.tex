...
In section \ref{chap:method} we will present an overview of the method
...
details in specific areas of interest, highlighting the overall
architecture and pipeline of constructing the different models, while
explaining the more important parts of the the architecture, with
particular focus on NLP and model construction.
...
We will discuss the tests with a strong focus on statistical analysis.
...
using a cosine distance measure of two term vectors representing
known information, $\textbf{s}$ and a harvested paragraph of information
$\textbf{p}$ which is defined as \footnote{Definition extracted from the
