...
Then we have the models two models $w, w'$, where $w$ is the googled
cleansed unigram model and $w'$ is the NLP model.

\todo[inline]{Flow model, pseudocode or something to make it more concrete}
